        ...
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <div class="content-wrap">
            	<div id="blockArea" class="">
                	<div class="row">
                    	<div class="col-lg-12">
                         	<iframe class="col-md-12 pull-left" id="iFrame" name="iFrame" style="width:101%; margin-left:-6px;" height="240" src= "index/main.do" scrolling= "auto" frameborder= "0"></iframe> 
                    	</div>
                	</div>
                </div>
